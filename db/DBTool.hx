...
class DBTool {
  ...
  public function new(
      ...
      ?tables: Array<DBTable>)
  {
    this.mapper = new DBMapper(); // TODO rethink about this way of implementation
  ...
  function updateSPODS(up){
    for (t in data.tables){
      ...
      // add public vars
      for( f in t.fields )
        generatedCode.push("  public var "+f.name+";");
      ...
      if (!neko.FileSystem.exists(file)){
        lines.push("// be careful. partially autogenerated code");
